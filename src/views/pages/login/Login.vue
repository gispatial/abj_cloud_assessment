      ...
      <vx-card>
        <div slot="no-body" class="full-page-bg-color">
          ...
          <div class="vx-row no-gutter justify-center items-center">
            ...
            <vs-list-header icon-pack="feather" icon="icon-shopping-cart" title="ABJ CLOUD SERVICES CRUD TEST DASHBOARD"></vs-list-header>
    <vs-list-item icon-pack="feather" icon="icon-check" title="The Dashboard Management Portal" subtitle="Please use credentials username: underwaterworldadmin passwd: abcd1234!"></vs-list-item>
            <div>
              &nbsp;
            </div>
              <div align="center">
              ...
              <div class="px-8 pt-8 login-tabs-container">
                ...
                <div class="vx-card__title mb-4">
                    <img src="@/assets/images/pages/logo-t2.png" alt="login" class="mx-auto" width="85%">
                        <div>&nbsp;</div>
                        <div class="vx-card__title mb-4">
                            <h6 class="mb-4"><b>LOGIN / REGISTER TO ABJ CLOUD</b></h6>
